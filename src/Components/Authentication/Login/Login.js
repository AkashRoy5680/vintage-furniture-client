...
const Login = () => {
    ...
    return (
        ...
        <p className="mt-2">Don't have an account? <Link className="text-decoration-none " to="/register" onClick={navigateRegistration}>create an account</Link></p>
